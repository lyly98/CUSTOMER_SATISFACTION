...
def prediction_service_loader(
    ...
    if not existing_services:
        raise RuntimeError(
            f"No MLflow prediction service deployed by the {pipeline_step_name} step in the {pipeline_name} pipeline for the '{model_name}' model is currently running."
        )
...
def customer_satisfaction_deployment_pipeline(
